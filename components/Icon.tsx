...
export type IconName = 'dashboard' | 'accounts' | 'platforms' | 'investments' | 'transactions' | 'receivables' | 'menu' | 'close' | 'plus' | 'edit' | 'delete' | 'wallet' | 'investment' | 'receivable-icon' | 'expense' | 'total-wealth' | 'transfer';
